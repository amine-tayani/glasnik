      ...
      <div className="text-gray-800 font-sand">
        <div className="flex flex-col flex-wrap p-2 mx-auto md:items-center md:flex-row">
          ...
          <div className="flex space-x-4">
            <Link href="/signup">
              <button className="w-auto px-8 py-2 my-2 text-white text-base transform transition duration-500 ease-in-out border-none font-bold bg-blue-600 hover:bg-blue-700 rounded-full focus:outline-none ">
                Sign up
              </button>
            </Link>
            <Link href="/login">
              <button className="w-auto px-8 py-2 my-2 text-base text-gray-900  transform transition duration-500 ease-in-out border-none font-bold bg-transparent hover:bg-gray-200 rounded-full focus:outline-none ">
                Log in
              </button>
            </Link>
          </div>
