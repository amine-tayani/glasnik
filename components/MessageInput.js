import { DocumentIcon, PhotographIcon, ArrowSmRightIcon } from "@heroicons/react/outline"
...
const MessageInput = () => {
  return (
    <div className="flex justify-center space-x-2 mt-8 items-center mx-12">
      ...
      />
      <button className="flex justify-center items-center bg-gradient-to-tr  from-indigo-400 to-blue-700 p-2 rounded-full transform transition hover:scale-105 duration-300 ease-in-out cursor-pointer">
        <svg
          className="w-6 h-6"
